...
from .password_handlers import (check_password_strength, generate_password, incorrect_pswrd,
...
__all__ = ["correct_email", "error_email", "correct_site", "correct_link", "error_link",
          ...
          "multiselect_clicked_prop", "multiselect_clicked_case", "incorrect_pswrd",
          "error_len_handler"]